/*jshint node:true globalstrict:true lastsemic:true*/
"use strict";
...
function POI(lat, lng, name) { LatLng.call(this, lat, lng); this.name = name }

POI.prototype = new LatLng(); // !!not best practice!!

// correct constructor
POI.prototype.constructor = POI;

// add / overwrite some methods
POI.prototype.toString = function () { return 'POI: ' + this.name };
POI.prototype.getName = function () { return this.name };
