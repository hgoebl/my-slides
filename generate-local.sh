...
echo "<a href='/nerdshow/rc/remote.html?/javascript'><img src='qrcode-javascript.png'/></a>" >> ${INDEX}

echo "<br><br><br><br>" >> ${INDEX}

echo "<a href='nodejs/'>Node.js</a>" >> ${INDEX}
echo "<a href='/nerdshow/rc/remote.html?/nodejs'><img src='qrcode-nodejs.png'/></a>" >> ${INDEX}

echo "<br><br><br><br>" >> ${INDEX}

echo "<a href='mongodb/'>MongoDB</a>" >> ${INDEX}
echo "<a href='/nerdshow/rc/remote.html?/mongodb'><img src='qrcode-mongodb.png'/></a>" >> ${INDEX}
